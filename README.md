...
![TastyTales Trailer](./src/assets/TastyTales_Trailer.gif)

## Features

- **Discover Recipes**: Explore a wide range of recipes, from trending dishes to hidden gems.
- **Share Your Creations**: Upload and share your own recipes with the TastyTales community.
- **Save Favorites**: Keep track of your favorite recipes and easily access them anytime.
- **Rate and Review**: Rate recipes and share your feedback to help others find the best dishes.
- **User Profiles**: Personalize your profile with a bio and profile picture, and manage your own collection of recipes.
